									...
									<div class="d-flex align-items-center">
										<div class="flex-grow-1">
											<input type="text" class="form-control my-3"
												placeholder="Search..." fdprocessedid="sp5mqa">
										</div>
									</div>
								</div>
								...
								<a href="#"
									...
									<div class="d-flex align-items-start">
										<img src="img/avatars/avatar-2.jpg"
											class="rounded-circle me-1" alt="William Harris" width="40"
											height="40">
										<div class="flex-grow-1 ms-3">
											William Harris
											<div class="small">
									...
									<div class="d-flex align-items-start">
										<img src="img/avatars/avatar-3.jpg"
											class="rounded-circle me-1" alt="Sharon Lessman" width="40"
											height="40">
										<div class="flex-grow-1 ms-3">
											Sharon Lessman
											<div class="small">
									...
									<div class="d-flex align-items-start">
										<img src="img/avatars/avatar-4.jpg"
											class="rounded-circle me-1" alt="Christina Mason" width="40"
											height="40">
										<div class="flex-grow-1 ms-3">
											Christina Mason
											<div class="small">
									...
									<div class="d-flex align-items-start">
										<img src="img/avatars/avatar-5.jpg"
											class="rounded-circle me-1" alt="Fiona Green" width="40"
											height="40">
										<div class="flex-grow-1 ms-3">
											Fiona Green
											<div class="small">
									...
									<div class="d-flex align-items-start">
										<img src="img/avatars/avatar-2.jpg"
											class="rounded-circle me-1" alt="Doris Wilder" width="40"
											height="40">
										<div class="flex-grow-1 ms-3">
											Doris Wilder
											<div class="small">
									...
									<div class="d-flex align-items-start">
										<img src="img/avatars/avatar-4.jpg"
											class="rounded-circle me-1" alt="Haley Kennedy" width="40"
											height="40">
										<div class="flex-grow-1 ms-3">
											Haley Kennedy
											<div class="small">
									...
									<div class="d-flex align-items-start">
										<img src="img/avatars/avatar-3.jpg"
											class="rounded-circle me-1" alt="Jennifer Chang" width="40"
											height="40">
										<div class="flex-grow-1 ms-3">
											Jennifer Chang
											<div class="small">
								...
								<div class="flex-grow-0 py-3 px-4 border-top">
									<div class="input-group">
										<input type="text" class="form-control"
											placeholder="Type your message" fdprocessedid="w52qk6">
										<button class="btn btn-primary" fdprocessedid="2o171">Send</button>
									</div>
								</div>
