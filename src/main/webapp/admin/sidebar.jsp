	...
	<div class="sidebar-content js-simplebar">
		...
		<ul class="sidebar-nav">
			...
			<li class="sidebar-item "><a class="sidebar-link"
				href="index.jsp"> <i class="align-middle" data-feather="sliders"></i>
			...
			<li class="sidebar-item"><a class="sidebar-link"
				href="adlist.jsp"> <i class="align-middle" data-feather="eye"></i>
					<span class="align-middle">View Ads</span>
			</a></li>
