...
Connection con =  ConnectionProvider.getConnection();
 String sql = "insert into shopkeeper(shopRegNo, shopName, shopAddress,	shopEmail, shopLocation, shopkeeperFirstName, shopkeeperMiddletName, shopkeeperLastName, shopkeeperMOB, shopkeeperEmail, shopkeeperpassword, category)values(?,?,?,?,?,?,?,?,?,?,?,?)";
